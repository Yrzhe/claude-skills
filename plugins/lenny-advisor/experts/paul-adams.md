...
- **When to use**: When a major product, market, or company shift makes prior assumptions obsolete.
- **Steps**:
...
- **When to use**: When building in uncertain environments where learning speed matters more than perfection.
- **Steps**:
  1. Release early instead of waiting for a perfect version.
  2. Use shipping as a way to learn what works and what doesn’t.
  3. Iterate quickly based on feedback and observed behavior.
  4. Maintain high standards while accepting that mistakes are part of the process.
- **Example**: Intercom’s internal principle evolved from “Ship to Learn” to “Ship fast, ship early, ship often.”

### Map Product Capability Against AI Capability
- **When to use**: When deciding whether and how AI should reshape a product strategy.
- **Steps**:
  1. Start with the core premise of the product: what problem it solves and why people use it.
  2. Ask whether AI can fully do that job, partially do it, or not do it yet.
  3. Classify the impact as replacement or augmentation.
  4. Identify which parts of the product are in AI’s path and require strategic change.
- **Example**: Intercom asked whether customer support could be done by AI; the answer was yes for many cases, leading to Fin as an AI-first support product.

### Differentiation vs Table Stakes
- **When to use**: When prioritizing roadmap investments in a competitive category.
- **Steps**:
  1. Separate features that make the product attractive from features required to compete at all.
  2. Invest in differentiation that customers actually care about.
  3. Build table stakes features needed for adoption and switching.
  4. Continuously rebalance the mix as the market matures.
- **Example**: Intercom initially over-invested in differentiation and later had to build basic permissions and reporting to enable customers to fully switch from Zendesk or Service Cloud.

### Swing the Pendulum
- **When to use**: When a team has overcorrected into an unbalanced state and needs to restore equilibrium.
- **Steps**:
  1. Recognize the current undesirable extreme.
  2. Make a deliberate corrective move in the opposite direction.
  3. Watch for overcorrection and the next imbalance.
  4. Iterate until the team lands in a workable middle.
- **Example**: Intercom swung from too much differentiation to too much table stakes, and later found a more balanced 50/50 approach.

### Product-Market-Story Fit
- **When to use**: When a good product is failing to gain traction despite apparent market potential.
- **Steps**:
  1. Confirm the product solves a real problem for a meaningful market.
  2. Assess whether the market has enough people with high urgency around the problem.
  3. Evaluate whether the story is simple and compelling enough to explain why the product is better.
  4. Refine positioning and messaging if the product-market fit exists but the story is weak.
- **Example**: Paul contrasted Spotify and Ordio, arguing that Ordio may have had a strong product but lost because the story/positioning was weaker.

### Jobs to Be Done + Four Forces
- **When to use**: When trying to understand why customers switch, adopt, or resist a product.
- **Steps**:
  1. Identify the job the customer is trying to accomplish.
  2. Interview for the customer’s energy and urgency around that job.
  3. Use the four forces to understand adoption and switching: attraction to the new solution, habits, anxieties, and the push of the current situation.
  4. Translate insights into job stories and product decisions.
- **Example**: Eoghan and Des used the four forces to persuade Paul to join Intercom by addressing his anxieties and attraction to the new opportunity.
...
- “At Facebook, you can design the product. But at Intercom, you can design the company.”
