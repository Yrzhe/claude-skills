...
### Founder-led learning before hiring specialists
- **When to use**: When a startup is tempted to hire its way out of an early capability gap.
- **Steps**:
...
- **Steps**:
  ...
  3. Expect the heat to shift from product to engineering to sales to marketing over time.
  4. Reallocate leadership attention as the company matures.
...
- **Steps**:
  ...
  3. Measure attention and recall, not just pipeline metrics.
  4. Iterate rapidly because failed campaigns do not create product debt.
- **Example**: Wiz replaced a conventional cyber booth with a Wizard of Oz-themed booth and got 5x the traffic of the prior year.

### Dummy explanation
- **When to use**: When writing or speaking about a technical product to a broader audience.
- **Steps**:
  1. Assume the audience knows nothing about your internal jargon.
  2. Remove acronyms and internal category language unless absolutely necessary.
  3. Rewrite until a non-expert can understand it immediately.
  4. Prefer simple, plain-language descriptions over clever technical phrasing.
