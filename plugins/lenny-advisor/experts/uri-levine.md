...
- **When to use**: At the very beginning of a startup, when choosing what to build and how to frame the company.
- **Steps**:
  1. Start from a problem that personally frustrates you.
  2. Make sure the problem is big and worth solving.
  3. Validate that many other people have the same problem.
  4. Talk to those people before building the solution.
  5. Use the problem as the North Star for the company story and product decisions.
  6. Only then design the solution.
- **Example**: Waze was framed not as an AI crowd-sourced navigation system, but as a way to help people avoid traffic jams and create certainty.

### Problem Validation Through User Conversations
- **When to use**: Before building, especially when deciding whether a problem is real and widespread.
- **Steps**:
  1. Identify who has the problem.
  2. Speak with many people who are not close friends or family.
  3. Listen for whether they recognize the problem immediately or redefine it in their own words.
  4. Treat repeated, specific pain as validation.
  5. If people say they know someone else with the problem, treat that as weak validation.
- **Example**: Uri recommends speaking with about 100 people in total, including at least 20 you don't know, to validate the problem.

### Startup Journey as Iteration and Failure
- **When to use**: When building something new and uncertain, especially before product-market fit.
- **Steps**:
  1. Expect a roller-coaster journey with frequent ups and downs.
  2. Assume failure is part of the process.
  3. Fail fast so you can try more approaches.
  4. Iterate on product, go-to-market, and business model until something works.
  5. Aim for good enough rather than perfect.
- **Example**: Waze iterated for more than a year across multiple versions and markets before reaching good enough product-market fit.

### Phase-Based Startup Focus
- **When to use**: When deciding what the company should optimize for at each stage.
- **Steps**:
  1. In the early phase, focus almost entirely on product-market fit.
  2. Once product-market fit is reached, shift to either growth or business model discovery depending on the product.
  3. If the product has high-frequency use and word-of-mouth potential, prioritize growth.
  4. If the product is low-frequency, prioritize business model and monetization earlier.
  5. Do not try to optimize multiple phases at once.
- **Example**: Waze initially focused on product-market fit, then later shifted toward growth and monetization through advertising.

### Investor Pitch Structure
- **When to use**: When fundraising for an early-stage startup.
- **Steps**:
  1. Open with your strongest point immediately.
  2. Use the first slide to make the most important claim.
  3. Tell a story that creates emotional engagement, not just facts.
  4. Show that the product is usable and that the team can build it.
  5. End with a strong final slide that repeats the key point.
- **Example**: Uri says the first slide should contain the strongest point, and the last slide should also repeat the strongest point rather than just saying thank you.

### Hire/Fire 30-Day Keeper Test
- **When to use**: After hiring someone new, or when evaluating whether a team member is right for the company.
- **Steps**:
  1. Mark a calendar 30 days after each hire.
  2. Ask: knowing what I know today, would I hire this person?
  3. If yes, reinforce and reward them.
  4. If no, fire them immediately.
  5. Use references and top performers to confirm hard decisions.
- **Example**: Uri recommends asking top performers how much they would care if a questionable employee left; if the answer is “not much,” that confirms the decision.

### Understand Users by Watching the Unsuccessful
- **When to use**: When improving a product or trying to understand why users churn or fail to adopt.
- **Steps**:
  1. Watch real users use the product.
  2. Look for surprising behaviors and different usage patterns.
  3. Ask why users behave differently than expected.
  4. Focus especially on users who failed to convert or churned.
  5. Use the “why” to drive the next product iteration.
