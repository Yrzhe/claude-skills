...
### Founder-led sales as market learning
- **When to use**: When a startup is pre- or early-product-market-fit and needs its first customers, especially before brand, references, and a mature product exist.
- **Steps**:
...
- **Steps**:
  1. Lead with relevance to the recipient’s role or current situation.
  2. Include a counterintuitive or surprising insight that creates a “wait, what?” reaction.
...
- **Steps**:
  1. Manually identify 30 people you are genuinely excited to learn from or sell to.
  2. Spend 15–20 minutes writing each a thoughtful note.
...
- **Steps**:
  1. Open with vulnerability about being early stage and still learning.
  2. State the problem you are passionate about solving and your current hypothesis.
  3. Ask how the problem manifests on their side.
  4. Probe whether the problem is being measured or managed.
  5. Ask how they have tried to solve it already.
  6. Explore how they visualize a solution before showing a product.
  7. Book the second call before ending the first call.
- **Example**: “We’re an early stage startup... can we gain your insight into how this problem is manifesting on your side?” followed by no demo on the first call.

### Problem qualification test
- **When to use**: When determining whether a prospect’s pain is real enough to support a buying process.
- **Steps**:
  1. Check whether the problem is growing or widening rather than static.
  2. Ask whether the company is measuring or managing the problem today.
...
- **Steps**:
  1. Invite the customer to help define the scope of work or rollout.
  2. Use co-authorship to assess their buying maturity and whether they have a process already.
  3. If they lack a process or strategy, sell a time-boxed service engagement first.
  4. Use the service engagement to educate, design the process, and create internal buy-in.
  5. Convert that learning into a later technology contract.
- **Example**: A startup gets paid to help a customer design the internal pitch or implementation plan before the customer is ready to buy software.

### 90-day service bridge to software
- **When to use**: When the buyer wants the outcome but is not operationally ready to buy or deploy the technology yet.
- **Steps**:
  1. Offer a service or consulting engagement tied directly to eventual product adoption.
  2. Time-box it to 90 days.
  3. Use the period to educate stakeholders, define process, and map implementation.
  4. Clarify that the service is in service of the product purchase, not open-ended consulting.
  5. At the end of 90 days, rescope based on what the customer now needs.
- **Example**: A startup works with a traditional industry customer to map workflow and integration before winning the technology contract.

### Procurement navigation playbook
- **When to use**: When an enterprise deal enters procurement, legal, IT, or finance review.
- **Steps**:
  1. Treat procurement as a separate sale to professional buyers.
  2. Clearly differentiate your product so procurement does not redirect the buyer to an existing vendor.
  3. Make the offering easy to classify and avoid vague positioning that triggers high-risk treatment.
...
- **Steps**:
  1. Identify who the actual signer is before the contract reaches them.
  2. Learn what that signer cares about and what context they need.
