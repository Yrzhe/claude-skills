...
- **When to use**: When you are trying to become more strategic, earn senior leadership trust, or respond to feedback that you are not strategic enough.
- **Steps**:
  1. Articulate a compelling and simple why behind the decisions and direction of the company or product.
  2. Champion hard but important changes that are in the long-term interest of the business.
...
- **Steps**:
  1. Pause the discussion and explicitly summarize what you have heard.
  2. Capture the customer problems, proposed solution direction, and the company's right to win.
  3. State the implied action or decision.
  4. End with a question asking whether the summary is accurate or where there is dissent.
  5. Use alternate formats if needed: whiteboard, Zoom chat, or written synthesis.
- **Example**: “I've heard that our customers are having these kinds of challenges. We feel like this is the way that we want to solve these challenges. We have a right to win in this way and therefore we're going to take this action. Is everyone in agreement with that?”

### One-click-better strategy development
- **When to use**: When you need to generate stronger strategic ideas but don't have a breakthrough concept yet.
- **Steps**:
  1. Listen to multiple stakeholders and synthesize their perspectives.
  2. Take the current idea or direction and ask how to make it one click better.
...
- **Steps**:
  1. Recognize founder mode as a source of leverage, not just interference.
  2. Use the founder's power to unblock or accelerate initiatives that are best for the company.
...
- **Steps**:
  1. Collect detailed information about the business, decisions, and performance.
  2. Decide selectively where intervention is actually needed.
  3. Get involved early rather than after a strategy is already locked.
...
- **Steps**:
  1. Study past product launches, especially failures and why they failed.
  2. Understand how prior decisions were made and what assumptions drove them.
...
- **Steps**:
  1. Define the core hypothesis or set of assumptions behind the decision.
  2. Acknowledge what you know and what you do not know.
  3. Make the decision once you are roughly 70% confident rather than waiting for certainty.
  4. Execute so you can gather higher-fidelity information from reality.
  5. Iterate based on what you learn, even if some work must be discarded.
- **Example**: She described products built for a new persona that failed because the company had not figured out who would sell it; the lesson was to validate the selling motion before building.

### Difficult-colleague navigation
- **When to use**: When you need to work effectively with someone whose style is frustrating, political, or hard to collaborate with.
- **Steps**:
  1. Assume you can work with anyone.
  2. Figure out what drives the person: company impact, status, career goals, or something else.
...
- **Steps**:
  1. Let yourself feel the emotional reaction instead of suppressing it.
  2. Do not react immediately.
  3. Return later with curiosity about where the feedback is coming from.
  4. Gather more context from the giver or others if needed.
  5. Decide whether action is warranted based on what the company most needs from you right now.
- **Example**: When told she was not strategic enough, she processed the sting first, then investigated what people actually meant by “strategic.”

### Giving hard feedback with care and directness
- **When to use**: When someone needs difficult feedback and you want them to hear it rather than become defensive.
- **Steps**:
  1. Explicitly state that you care about the person and want them to succeed.
  2. Tailor the feedback to their career goals by first asking where they want to go.
  3. Be direct rather than passive-aggressive.
