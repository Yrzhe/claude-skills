...
### Impact-first operating model
- **When to use**: When leading teams, reviewing strategy, or evaluating performance and execution.
- **Steps**:
  1. Define the north-star outcome and the impact you want to create.
  2. Measure work by outcomes, not activity or effort.
...
- **Steps**:
  1. Find talent by looking for signs of excellence and repeated success.
  2. Assess talent by weighing positive signals and red flags across the full conversation.
  3. Close talent by involving the broader executive team and, when relevant, the candidate’s spouse or family.
  4. Stay relentless and keep momentum alive until the candidate makes a decision.
- **Example**: When Luc was recruited by Mark Zuckerberg, the process involved the full executive team, dinner with spouses, and months of persistent follow-up before he eventually joined.

### Signs-of-excellence hiring filter
- **When to use**: When screening candidates and trying to identify top 1% talent.
- **Steps**:
  1. Look for repeated excellence, not a single isolated win.
  2. Ask about both professional and non-professional achievements.
  3. Look for evidence of grit, drive, and unusual accomplishment.
  4. Treat signals like a former boss returning to poach the candidate as especially strong.
  5. Use the full pattern of evidence rather than overreacting to one signal.
- **Example**: Luc cited examples such as founders, award winners, gold medalists, or people whose former boss left and later came back to recruit them.

### Advisor selection and structuring framework
- **When to use**: When bringing on a growth advisor or deciding whether advisory support makes sense.
- **Steps**:
  1. Wait until you have product-market fit before leaning heavily into growth.
  2. Choose advisors who understand both what to do and why it works.
  3. Use trusted internal or external experts to vet advisor quality.
  4. Prefer equity-based compensation to align incentives.
  5. Front-load vesting and use a short cliff so both sides can exit quickly if the fit is wrong.
  6. Expect the advisor to deliver value quickly, train the team, and not be needed forever.
- **Example**: Luc prefers a three-month cliff and front-loaded vesting so an advisor is incentivized to create value fast and teach the team rather than hold back knowledge.

### Growth channel selection framework
- **When to use**: When deciding where to invest growth effort across SEO, social, viral loops, partnerships, onboarding, or new product bets.
- **Steps**:
  1. Start by identifying where user intent already exists.
  2. Map the available channels: SEO, paid search, social, influencers, viral loops, partnerships, onboarding, and even M&A or new product creation.
  3. Test broadly, then double down on the one or two channels that work best.
  4. Treat growth as whatever moves the needle, not as a fixed function or channel list.
- **Example**: Luc pointed to Tripadvisor winning through SEO, Facebook through viral loops, and Priceline through SEM as examples of companies dominated by one strong channel.

### SEO opportunity segmentation
- **When to use**: When planning SEO for a company with either a small site or a large content/UGC surface.
- **Steps**:
  1. Determine whether the site has a small number of pages or a large, automatically expanding page surface.
  2. For small sites, optimize existing pages and create content that answers audience questions.
  3. For large UGC or marketplace sites, optimize the massive page surface and leverage the built-in growth loop.
  4. Recognize that a single keyword or a small set of keywords can define an entire business.
- **Example**: Luc described LinkedIn as a viral loop feeding an SEO loop, and TravelPod as a business where the keyword “travel blog” was strategically important.

### Advisor-as-investor mental model
- **When to use**: When deciding whether to take an advisory role or evaluating whether to work with a company as an advisor.
- **Steps**:
  1. Treat the decision like an investment, not just a consulting engagement.
  2. Evaluate the likelihood of company success and liquidity.
  3. Only take on companies where you believe there is a strong chance of a meaningful outcome.
  4. Make sure the equity structure has a long enough tail to match the time horizon.
- **Example**: Luc said he often thinks in terms of a 10-year horizon and wants the deal structure to reflect that reality.

### Structured self-reflection system
- **When to use**: When trying to improve as a leader, parent, spouse, or operator over time.
- **Steps**:
  1. Set aside dedicated time each morning for reflection.
  2. Review what is going well, what is not, and why.
  3. Track key life and work areas with a red-yellow-green dashboard.
  4. Ask for direct feedback from the people closest to you.
  5. Turn feedback into recurring habits and routines.
- **Example**: Luc asked his kids how he could be a better dad, then created recurring one-on-one “daddy dates” every two weeks.
