...
- **Steps**:
  1. Notice your own internal dialogue and stop being distracted by your own thoughts.
  2. Listen for the words and repeat back the content accurately.
...
- **Steps**:
  1. G: Define the goal or desired outcome.
...
- **Steps**:
  1. Observation: State the factual behavior or event without interpretation.
...
- **Steps**:
  1. Build self-awareness about your own strengths, weaknesses, and triggers.
  2. Create a shared language for the dynamic, using tools like Enneagram or direct strengths/weaknesses discussion.
  3. Make explicit commitments or “vows” about how you will work together.
  4. Schedule recurring check-ins at multiple cadences: weekly, monthly, quarterly, and annually.
  5. Step out of the day-to-day hustle and get on the “balcony” to reflect on alignment, conflict, and culture.
- **Example**: A co-founder duo used 360 feedback, weekly virtual check-ins, and quarterly in-person meetings to repair distance and recommit to the business.

### Energy audit for designing a life around your gifts
- **When to use**: When you feel depleted, burned out, or unsure what kind of work actually energizes you.
- **Steps**:
  1. For two weeks, write down the five things each day that gave you energy.
  2. Write down the five things that depleted you.
  3. Look for patterns across the entries.
  4. Ask trusted people what they see as your gifts and strengths.
  5. Review your calendar for recurring themes of excitement vs. dread.
  6. Use the patterns to redesign your role, boundaries, or team structure.
- **Example**: Rachel realized she was energized by coaching and people work, not by product strategy, which led her to move into HR leadership and executive coaching.

### One-page plan operating system
- **When to use**: When a company needs clearer alignment between vision, strategy, goals, and day-to-day execution.
- **Steps**:
  1. Put vision and values in one place.
  2. Add strategic intentions and KPIs.
  3. Add annual goals.
  4. Add quarterly goals.
  5. Use the plan as a shared reference point for prioritization and communication.
  6. Review it regularly in an operating rhythm that includes reflection and discussion.
- **Example**: Alpine Investors’ People First Operating Rhythm aligns vision/values, strategic intentions/KPIs, annual goals, and quarterly goals on a single page.
...
> “No, your manager's job is to help you perform in the job you are hired to do. It's your job to navigate your career.”

> “If you can see your path laid out in front of you, step by step, it's not your path. Your own path, you make with every step you take.”